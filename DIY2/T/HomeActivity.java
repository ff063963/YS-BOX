                ...
                ApiConfig.get().loadJar(useCacheConfig, ApiConfig.get().getSpider(), new ApiConfig.LoadConfigCallback() {
                    ...
                    public void success() {
                        ...
                        mHandler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if (!useCacheConfig)
                                    Toast.makeText(HomeActivity.this, getString("自定义jar加载成功"), Toast.LENGTH_SHORT).show();
                                initData();
                            }
                        }, 50);
                    }
                    ...
                    public void error(String msg) {
                        ...
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(HomeActivity.this, getString("jar加载失败"), Toast.LENGTH_SHORT).show();
                                initData();
                            }
                        });
                    }
