...
//设置界面
cp $CURRENT_DIR/DIY2/J/设置/HomeActivity.java            $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/activity/HomeActivity.java
...
cp $CURRENT_DIR/DIY2/J/设置/dialog_version.xml $CURRENT_DIR/$DIR/app/src/main/res/layout/dialog_version.xml
...
#共存
sed -i 's/com.github.tvbox.osc/com.tvbox./g' $CURRENT_DIR/$DIR/app/build.gradle
