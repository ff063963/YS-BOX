...
//设置界面修改
#mv $CURRENT_DIR/DIY/q2/设置/HomeActivity.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/activity/HomeActivity.java
#cp $CURRENT_DIR/DIY/q2/设置/ModelSettingFragment.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/fragment/ModelSettingFragment.java
#cp $CURRENT_DIR/DIY/q2/设置/fragment_model.xml $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml

//增加版本 更新说明
#mv $CURRENT_DIR/DIY/q2/设置/VersionDialog.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/dialog/VersionDialog.java

#mv $CURRENT_DIR/DIY/q2/设置/dialog_version.xml $CURRENT_DIR/$DIR/app/src/main/res/layout/dialog_version.xml
#sed -i 's/6666/修改epg/g'   $CURRENT_DIR/$DIR/app/src/main/res/layout/dialog_version.xml

#播放界面修改
#cp $CURRENT_DIR/DIY/q2/播放/player_vod_control_view.xml  $CURRENT_DIR/$DIR/app/src/main/res/layout/player_vod_control_view.xml
#cp $CURRENT_DIR/DIY/q2/播放/VodController.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/player/controller/VodController.java
#mv $CURRENT_DIR/DIY/q2/播放/shape_dialog_top_bg.xml  $CURRENT_DIR/$DIR/app/src/main/res/drawable/shape_dialog_top_bg.xml
#mv $CURRENT_DIR/DIY/q2/播放/play_mobile_center_shape.xml  $CURRENT_DIR/$DIR/app/src/main/res/drawable/play_mobile_center_shape.xml
#播放界面增加外部播放器
#cp $CURRENT_DIR/DIY/q2/播放/PlayFragment.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/fragment/PlayFragment.java

#搜索修改
#cp $CURRENT_DIR/DIY/q2/搜索/SearchActivity.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/activity/SearchActivity.java

#内置接口
#cp $CURRENT_DIR/DIY/ApiConfigQ.java  $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/api/ApiConfig.java
...
//播放界面修改
#cp $CURRENT_DIR/DIY/q2/播放/PlayerHelper.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/util/PlayerHelper.java
...
#首页多排
#sed -i 's/60/4/g' $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/ui/activity/HomeActivity.java 
...
#版本号
#sed -i 's/1.0.0/1.4.7/g' $CURRENT_DIR/$DIR/app/build.gradle
#sed -i 's/1.0.0/1.4.7/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml
#共存
